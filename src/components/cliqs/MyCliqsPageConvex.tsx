        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
            <Link href="/profile/edit">
              <Button variant="outline" className="w-full sm:w-auto text-xs py-1 px-2 sm:text-sm sm:py-2 sm:px-4">
            ...
            <Link href="/cliqs/build">
              <Button className="w-full sm:w-auto text-xs py-1 px-2 sm:text-sm sm:py-2 sm:px-4">
                <svg className="w-3 h-3 mr-1 sm:w-4 sm:h-4 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
