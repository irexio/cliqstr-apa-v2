        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link
              ...
              className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2.5 rounded-lg font-medium transition-colors text-sm md:text-base"
            >
            ...
            <Link
              href="/cliqs/build"
              className="flex items-center justify-center gap-2 bg-black hover:text-[#c032d1] text-white px-4 py-2.5 rounded-lg font-medium transition-colors shadow-sm text-sm md:text-base"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
